...
public class SaltLanternBlock extends LanternBlock {
    private static final VoxelShape SHAPE_STANDING = Shapes.or(Block.column(8.0, 0.0, 8.0), Block.column(10.0, 7.0, 11.0));
